            ...
            <div className="hidden md:flex gap-6 items-center text-white text-sm font-medium">
              <Link
                ...
                className={`hover:text-epiclinx-teal transition-all font-light ${
                  pathname === "/dashboard/brand" ? "text-[#00e0ca]" : ""
                }`}
              >
                Dashboard
              </Link>
              <Link
                ...
                className={`hover:text-epiclinx-teal transition-all font-light ${
                  pathname.startsWith("/dashboard/brand/find-creators")
                    ? "text-[#00e0ca]"
                    : ""
                }`}
              >
      ...
      >
        ...
        <div className="flex flex-col justify-between h-full">
          ...
          <div className="flex flex-col gap-8 mt-16 px-4">
            ...
            <NavMenuItem href="/dashboard/brand/find-creators">
              Find Creators
            </NavMenuItem>
