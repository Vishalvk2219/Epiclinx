...
import { Briefcase, ChevronLeft, ChevronRight, DollarSign, Ellipsis, Gavel, Search, Users } from "lucide-react"
...
const CampaignList = () => {
    ...
    const filteredJobs = activeSection === "campaigns" ? jobs : jobs.filter((job) => job.status === activeTab)
    ...
    return (
        <div>
            ...
            <span className="text-white/90 text-xs">200 jobs found</span>
            <br/>
            <br/>
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex flex-wrap items-center gap-4">
                                    ...
                                    <div className="ml-auto text-white text-xs font-light">
                                        <div className="text-white text-sm">
                                            {job.applicants > 0 ? `${job.applicants} Applicants` : `${job.bids} Applicants`}
                                        </div>
                                    </div>
                                </div>
                            </div>
