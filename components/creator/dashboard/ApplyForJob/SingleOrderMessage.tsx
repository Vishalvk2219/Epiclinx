...
export function SingleOrderMessage() {
                    ...
                    <div className="flex flex-col gap-4 max-md:hidden">
                        ...
                        <div className="py-2 px-5">
                            ...
                            <Link href={"/profile/creator"}>
                                <button className="bg-white/10 flex w-full justify-center hover:bg-white/20 hover:transition-all hover:duration-300 text-white rounded-full px-4 py-3 mt-4">
                                    View Profile
                                </button>
                            </Link>
                ...
                >
                    ...
                    <div className="p-4 border-t border-[#3A3A3A] mt-auto">
                        <div className="flex flex-col md:flex-row items-center md:items-stretch gap-2 relative w-full">
                            {/* Submit Work Button */}
                            <button className="bg-epiclinx-teal w-full md:w-auto rounded-full px-4 py-2 text-black btn-hover">
                                Submit Work
                            </button>
