...
export function JobsList({ show = true, publicProfile = false }: { show?: boolean, publicProfile?: boolean }) {
  const [activeTab, setActiveTab] = useState<string>(publicProfile ? "Completed Jobs" : "Pending Applications")
  const [currentPage, setCurrentPage] = useState(1)
  const [activeSection, setActiveSection] = useState<"jobs" | "messages">("jobs")
  const itemsPerPage = 5

  const tabs = publicProfile
    ? ["Completed Jobs", "Pending Applications", "Accepted Jobs", "Jobs In Progress", "Submitted Jobs", "Declined Jobs"]
    : ["Pending Applications", "Accepted Jobs", "Jobs In Progress", "Submitted Jobs", "Completed Jobs", "Declined Jobs"]
    ...
    <div className="rounded-3xl overflow-hidden">
      <div className="">
        <div className="flex items-center max-md:flex-col max-md:items-start max-md:gap-4 justify-between mb-6">
            ...
            show ? (
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center">
                  <Image
                    src={"https://easy-peasy.ai/cdn-cgi/image/quality=80,format=auto,width=700/https://media.easy-peasy.ai/fb9a7875-06f1-48d6-b719-ba908fd7217f/f8225861-19d3-4b7e-8bdc-d4cee17872ca.png"}
                    alt="User"
                    width={50}
                    height={50}
          ...
          {
            !publicProfile && <div className="flex rounded-full bg-[#3A3A3A] p-1">
              <button
        ...
        {activeSection === "jobs" ? (
          <>
            {
              !publicProfile && <>
                <div className="text-white mb-6 text-xs font-light">{jobs.length} Jobs Applied For – Every move is building your legacy.</div>
